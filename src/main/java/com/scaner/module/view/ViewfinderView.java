...
package com.scaner.module.view;
...
public final class ViewfinderView extends View {
	...
	public ViewfinderView(Context context, AttributeSet attrs) {
		...
		maskColor = resources.getColor(R.color.qrscanner_viewfinder_mask);
		resultColor = resources.getColor(R.color.qrscanner_result_view);

		resultPointColor = resources.getColor(R.color.qrscanner_possible_result_points);
	...
	public void onDraw(Canvas canvas) {
		...
		if (resultBitmap != null) {
			...
			canvas.drawRect(frame.right - L_WIDTH, frame.top, frame.right,
					frame.bottom, paint);
			// 画扫描框边上的角，总共8个部分
			paint.setColor(Color.parseColor("#1172d5"));
...
//			if ((QrScannerActivity.currentState != null)
//					&& (QrScannerActivity.currentState.equals("onecode"))) {
//				canvas.drawText(
...
//			}
//			if ((QrScannerActivity.currentState != null)
//					&& (QrScannerActivity.currentState.equals("qrcode"))) {
